...
class AnimatedPropertyTest {
    ...
    void exprClipOverridesCurveInsideRange() {
        ...
        assertNull(p.exprClips(0).get(0).error(), "a valid expression has no error");
    ...
    void invalidExprClipFallsBackToCurve() {
        ...
        assertNotNull(p.exprClips(0).get(0).error(), "a malformed expression reports a syntax error");
