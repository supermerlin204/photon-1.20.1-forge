...
public class RenderGraphResource extends GraphResource<RenderGraph> {
    ...
    private static int packArgb(float[] rgba) {
        int r = Math.round(com.lowdragmc.photon.util.MathCompat.clamp(rgba[0], 0f, 1f) * 255f);
        int g = Math.round(com.lowdragmc.photon.util.MathCompat.clamp(rgba[1], 0f, 1f) * 255f);
        int b = Math.round(com.lowdragmc.photon.util.MathCompat.clamp(rgba[2], 0f, 1f) * 255f);
        int a = Math.round(com.lowdragmc.photon.util.MathCompat.clamp(rgba[3], 0f, 1f) * 255f);
