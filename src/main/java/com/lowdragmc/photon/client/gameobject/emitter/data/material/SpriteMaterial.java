...
public class SpriteMaterial extends ShaderInstanceMaterial {
    ...
    private SpriteSet getSpriteSet() {
        ...
        return ((ParticleEngineAccessor) Minecraft.getInstance().particleEngine)
                .getSpriteSets().get(spriteLocation);
    }
    ...
    public void buildConfigurator(ConfiguratorGroup father) {
        ...
        father.addConfigurator(new SelectorConfigurator<>("SpriteMaterial.spriteLocation",
                ...
                true, ((ParticleEngineAccessor) Minecraft.getInstance().particleEngine)
                        .getSpriteSets().keySet().stream().toList(), ResourceLocation::toString));
    }
}
