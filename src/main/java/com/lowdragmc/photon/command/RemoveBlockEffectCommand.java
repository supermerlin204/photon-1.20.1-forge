...
public class RemoveBlockEffectCommand {
    ...
    private static int execute(CommandContext<CommandSourceStack> context, boolean force, boolean location) throws CommandSyntaxException {
        ...
        PhotonNetworking.sendToPlayersTrackingChunk(
                context.getSource().getLevel(), new ChunkPos(command.pos), command);
    ...
    public static RemoveBlockEffectCommand decodePacket(FriendlyByteBuf buf) {
